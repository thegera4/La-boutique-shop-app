...
object Constants {
    ...
    const val PICK_IMAGE_PERMISSION_CODE = 1
    const val READ_PERMISSION_CODE = 2
    ...
    const val OFICINA: String = "Oficina"
    const val OTRO: String = "Otro"

    const val ADD_ADDRESS_REQUEST_CODE: Int = 121

    fun showImageChooser(activity: Activity){
        //Intent to launch the image selector of phone
        val galleryIntent = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI)
        //Launches the image selection of phone storage using the constant code
        activity.startActivityForResult(galleryIntent, PICK_IMAGE_PERMISSION_CODE)
    }
